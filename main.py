...
# needed to set operator params (mapping generated by chatgpt)
with open("./params/OperatorMap.json", "r") as f:
    mmap_json = {int(k): v for k, v in json.load(f).items()}
# general midi map
with open("./params/MidiMap.json", "r") as f:
    midimap_json = {int(k): v for k, v in json.load(f).items()}
